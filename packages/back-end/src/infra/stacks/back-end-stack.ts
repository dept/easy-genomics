  ...
  constructor(scope: Construct, id: string, props: BackEndStackProps) {
    ...
    NagSuppressions.addResourceSuppressionsByPath(
      ...
      [
        ...
        `/${this.props.namePrefix}-main-back-end-stack/${this.props.envName}-easy-genomics-nested-stack/${this.props.namePrefix}-easy-genomics/${this.props.namePrefix}-easy-genomics-request-folder-download-job/ServiceRole/DefaultPolicy/Resource`,
        `/${this.props.namePrefix}-main-back-end-stack/${this.props.envName}-easy-genomics-nested-stack/${this.props.namePrefix}-easy-genomics/${this.props.namePrefix}-easy-genomics-request-folder-download-job-status/ServiceRole/DefaultPolicy/Resource`,
        `/${this.props.namePrefix}-main-back-end-stack/${this.props.envName}-easy-genomics-nested-stack/${this.props.namePrefix}-easy-genomics/${this.props.namePrefix}-easy-genomics-process-folder-download-job/ServiceRole/DefaultPolicy/Resource`,
