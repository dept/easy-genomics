...
import { AddTagsToSequenceSetsSchema } from '@easy-genomics/shared-lib/src/app/schema/easy-genomics/data-collections/add-tags-to-sequence-sets';
...
export const handler: Handler = async (
  ...
  try {
    ...
    const parsed = AddTagsToSequenceSetsSchema.safeParse(body);
