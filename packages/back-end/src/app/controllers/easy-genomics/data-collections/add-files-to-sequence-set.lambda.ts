...
import { AddFilesToSequenceSetSchema } from '@easy-genomics/shared-lib/src/app/schema/easy-genomics/data-collections/create-sequence-set';
...
export const handler: Handler = async (
  ...
  try {
    ...
    if (!AddFilesToSequenceSetSchema.safeParse(body).success) throw new InvalidRequestError();
    ...
    await sequenceSetService.addFilesToSequenceSet(laboratory, userId, body.S3Bucket, body.SequenceSetId, body.Keys);
